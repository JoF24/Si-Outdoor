    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto px-5 nav-underline">
                ...
                <li class="nav-item px-3">
                    <a class="nav-link active navbar-font" aria-current="page" href="<?=BASEURL;?>/penyewaan/admin">Penyewaan</a>
                </li>
            </ul>
        </div>
        ...
        <tbody>
            ...
            foreach ($data['penyewaan'] as $penyewaan) : ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= BASEURL; ?>/penyewaan/edit/<?= $penyewaan['id_penyewaan']; ?>" class="btn btn-warning">Edit</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
