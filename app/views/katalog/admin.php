...
<div class="d-flex justify-content-end" style="height:40px;margin-right:100px;">
    <a href="<?=BASEURL;?>/katalog/tambah_data" class="btn btn-primary" role="button">+ Tambah Data Baru</a>
</div>
            ...
            foreach($data['produk'] as $dt): ?>
                <div class="col-3 mt-3">
                    <div class="card" style="height: 320px; width: 260px;">
                        ...
                        <a href="<?=BASEURL;?>/katalog/edit_katalog/<?=$dt['id_alat']?>" style="text-decoration: none;">
                            <div class="card align-items-center" style="width: 100px; height:30px;margin-left:17px;background-color:blue;">
                                <p style="color:white">Edit Data</p>
                            </div>
                        </a>
                    </div>
                </div>
